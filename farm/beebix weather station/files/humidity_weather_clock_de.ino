...
//byte Celsius[8] = {B01110,B10001,B01110,B00000,B00000,B00000,B00000,B00000}; lcd.createChar(0, Celsius); // graphical ° Symbol
 ...
 rtc.begin();
  ...
  show = 0;
  //pinMode(12, OUTPUT); //controls LCD Back Light - komentiert ist deaktiviert, port ist fÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼r Feuchte Sensor  (Neu im Code)
  //digitalWrite(12, HIGH);  - komentiert ist deaktiviert, Port ist fÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼r Feuchte Sensor  (Neu im Code)
...
void loop() {
  ...
  lcd.home(); 
  lcd.clear();
//lcd.print("--------------------"); // Muster Text lÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¤nge 
  lcd.setCursor(0, 0);
  lcd.print(" Wetterstation v1.0 "); //  - komentiert ist deaktiviert  (Neu im Code)
  lcd.setCursor(0, 1);
