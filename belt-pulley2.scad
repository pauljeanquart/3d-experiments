...
//translate([35,0,-50]) cylinder(150,1.5,1.5,$fn=20,true);
...
if ( profile == 6 ) { 
    ...
    translate([0,0,3.5]) rotate([90,0,0]) cylinder(40,1.5,1.5,$fn=40,true);
    
    translate([0,7,0]) cube([5.5,3,20],true);
    translate([0,-7,0]) cube([5.5,3,20],true);
    }
}
...
for (i=[0:15])
{
rotate([0,0,i*22.5]) translate([36,0,0]) cylinder(50,1.5,1.5,$fn=20,true);
}
